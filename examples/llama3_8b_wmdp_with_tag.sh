...
MODEL_PATH=/data/wenjie_jacky_mo/Debug_LM/saves/llama_debug_stop_wmdp  # replace it with your local file path
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=llama38b_sft_wmdp_grpo \
