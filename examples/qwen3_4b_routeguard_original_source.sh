...
DATA_DIR=/data/wenjie_jacky_mo/EasyR1/data/routeguard_single_original_data_oriented
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/routeguard.py:compute_score \
    ...
    trainer.experiment_name=qwen3_4b_routeguard_original_source \
