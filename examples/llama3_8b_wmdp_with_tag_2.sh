...
MODEL_PATH=/data/wenjie_jacky_mo/Debug_LM/saves/llama_debug_old  # replace it with your local file path
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=llama38b_wmdp_grpo_with_tag_fix_reward \
